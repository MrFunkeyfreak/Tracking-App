...
class UsersAdministrationViewAdminMobile extends StatefulWidget {
  const UsersAdministrationViewAdminMobile({Key? key}) : super(key: key);
  @override
                                    ...
                                    TextButton.icon(
                                      onPressed: () async => {
                                        ...
                                        if (selectedRow.length >= 2)
                                          {
                                            //for all users in the Map <String,dynamic> "selectedRow" update status to deleted and delete all personal informations + role to user
                                            for (var i = 0;
