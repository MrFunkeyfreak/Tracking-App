...
class UsersAdministrationViewAdminTablet extends StatefulWidget {
  const UsersAdministrationViewAdminTablet({Key? key}) : super(key: key);
                                      ...
                                      if (selectedRow.length == 1)
                                        {
                                          ...
                                          // delete user -> for this create a Map <String, dynamic> without the personal informations from
                                          // the user and set the status to deleted + role to user
                                          UpdateUser = {
                                            'id': uid,
                                            'username': '',
                                            'first name': '',
