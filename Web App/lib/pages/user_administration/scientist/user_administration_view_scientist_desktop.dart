...
// table to administrate every user
...
class UsersAdministrationViewScientistDesktop extends StatefulWidget {
  const UsersAdministrationViewScientistDesktop({Key? key}) : super(key: key);
...
class _UsersAdministrationViewScientistDesktopState
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        body: Center(
      // if user is scientist, then build up the side, otherwise show permission denied
                ...
                child: ListView(
                  children: [
                    ListTile(
                      ...
                      title: const Text("Wissenschaftlerverwaltung"),
                      onTap: () {
                                      ...
                                      if (selectedRow.length == 1)
                                        {
                                          ...
                                          // delete user -> for this create a Map <String, dynamic> without the personal informations
                                          // from the user and set the status to deleted + role to user
                                          UpdateUser = {
                                            'id': uid,
                                            'username': '',
                                            'first name': '',
