...
//creating an item which can be used in the TopNavigationBar instead of repeating the same everytime

class TopNavBarItem extends StatelessWidget {
  final String title;
  final String navigationPath;
  final IconData? icon;
  const TopNavBarItem(this.title, this.navigationPath, {Key? key, this.icon}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    // when the TopNavBarItem gets click, then navigate to the navigationPath - input: navigationPath - output: the page connected to the navigationPath (defined in router and routenames)
